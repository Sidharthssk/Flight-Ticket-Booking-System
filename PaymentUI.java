...
public class PaymentUI extends JFrame implements ActionListener {
        ...
        JLabel payment, numLbl, nameLbl, ageLbl, genderLbl, priceLbl1, priceLbl2, usernumberLbl, usernameLbl,
                        userageLbl, usergenderLbl,
        ...
        PaymentUI() {
                ...
                total = new JLabel(
                                "Total : Rs. " + Integer.toString(TicketDetailsUI.total + ReturnFlightShowingUI.total),
                                JLabel.LEFT);
        ...
        public void actionPerformed(ActionEvent e) {
                ...
                if (e.getSource() == cancel) {
                        ...
                        FlightBook.ticketQueue.remove(Users.usersList.get(index), Users.usersList.get(index).d.tail.data);
                        Users.usersList.get(index).d.remove();
                        //Remove ticket from circular queue
